...
QT_MOC_LITERAL(3, 17, 21) // "on_pushButton_clicked"
    ...
    "myForm\0SendData\0\0on_pushButton_clicked"
};
...
void myForm::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (myForm::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&myForm::SendData)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void myForm::SendData(QString _t1)
{
